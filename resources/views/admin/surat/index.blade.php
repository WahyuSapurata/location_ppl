    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
            ...
            <button class="btn btn-primary btn-sm " data-kt-drawer-show="true" data-kt-drawer-target="#side_form"
                id="button-side-form"><svg xmlns="http://www.w3.org/2000/svg" height="16" width="16"
                ...
                </svg> Kirim Surat</button>
            {{-- <a href="{{ route('admin.get-pdf') }}" target="_blank">pdf</a> --}}
            <!--end::Title-->
        </div>
        <!--end::Page title-->
        <!--begin::Actions-->
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <select name="mitra" class="form-select" data-control="select2" id="nama_mitra_select"
                            data-placeholder="Pilih jenis inputan">
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipart('/admin/add-surat', 'Tambah',
                    'Surat',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipart('/admin/update-surat/' + uuid, 'Update',
                    'Surat', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/show-surat/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Surat', url);
        });

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/delete-surat/' + $(this).attr('data-uuid');
            ...
            render: function(data, type, row, meta) {
                ...
                return `
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="fw-bolder text-capitalize">${status}</div>
                        </div>
                        </div>
                    `;
            }
    ...
    //         <a href="javascript:;" type="button" data-uuid="${data}" data-label="Surat" class="btn btn-danger button-delete btn-icon btn-sm">
