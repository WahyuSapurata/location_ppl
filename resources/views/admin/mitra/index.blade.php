            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <select name="bidang" class="form-select" data-control="select2" id="bidang_select"
                            data-placeholder="Pilih jenis inputan">

                        </select>
                        <small class="text-danger bidang_error"></small>
                    </div>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Mitra');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/admin/add-perusahaan', 'Tambah',
                    'Mitra',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/admin/update-perusahaan/' + uuid, 'Update',
                    'Mitra', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/show-perusahaan/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Mitra', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/delete-perusahaan/' + $(this).attr('data-uuid');
        ...
        function previewImage(input) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    // Tampilkan gambar
                    logoInfoContainer.html('<img src="' + e.target.result + '" style="max-width:100%;">');
                };
        ...
        let columns = [{
            ...
            render: function(data, type, row, meta) {
                let result =
                    `
                        <img src="{{ asset('storage/logo/${row.logo}') }}" style="max-width: 100%;" alt="">
                    `;
                return result;
            }
        }, {
        ...
        let columnDefs = [{
            ...
            render: function(data, type, full, meta) {
                ...
                <a href="javascript:;" type="button" data-uuid="${data}" data-label="Mitra" class="btn btn-danger button-delete btn-icon btn-sm">
        ...
        $(function() {
            control.push_select3(bidang, '#bidang_select');
            control.initDatatable('/admin/get-perusahaan', columns, columnDefs);
        })
    </script>
@endsection
