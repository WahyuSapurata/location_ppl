            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <select name="atribut" class="form-select" data-control="select2" id="atribut_select"
                            data-placeholder="Pilih jenis inputan">

                        </select>
                        <small class="text-danger atribut_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Bobot</label>
                        <input type="text" id="bobot" class="form-control" name="bobot">
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipart('/admin/add-kriteria', 'Tambah',
                    'Kriteria',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipart('/admin/update-kriteria/' + uuid, 'Update',
                    'Kriteria', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/show-kriteria/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Kriteria', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/admin/delete-kriteria/' + $(this).attr('data-uuid');
        ...
        $(function() {
            control.push_select3(atribut, '#atribut_select');
            control.initDatatable('/admin/get-kriteria', columns, columnDefs);
        })
    </script>
@endsection
