...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Minat');
        })
        ...
        $(document).on('click', '.button-update', function(e) {
            ...
            control.overlay_form('Update', 'Minat', url);
        })
            ...
            render: function(data, type, full, meta) {
                return `
                    ...
                    <rect x="0.5" width="24" height="24" fill="white"/>
                                    ...
                                    <a href="javascript:;" type="button" data-uuid="${data}" data-label="Minat" class="btn btn-danger button-delete btn-icon btn-sm">
