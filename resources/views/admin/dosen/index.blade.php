            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" id="nama_dosen" class="form-control" name="nama_dosen">
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Pembimbing');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipart('/admin/add-dosen', 'Tambah',
                    'Pembimbing',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipart('/admin/update-dosen/' + uuid, 'Update',
                    'Pembimbing', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/admin/show-dosen/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Pembimbing', url);
        })
        ...
        let columnDefs = [{
            ...
            render: function(data, type, full, meta) {
                ...
                <a href="javascript:;" type="button" data-uuid="${data}" data-kt-drawer-show="true" data-kt-drawer-target="#side_form" class="btn btn-primary button-update btn-icon btn-sm">
                    ...
                    <a href="javascript:;" type="button" data-uuid="${data}" data-label="Pembimbing" class="btn btn-danger button-delete btn-icon btn-sm">
        ...
        $(function() {
            control.initDatatable('/admin/get-dosen', columns, columnDefs);
        })
    </script>
@endsection
